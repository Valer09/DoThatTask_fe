...
// Select profile with -Penv=dev (default) or -Penv=prod, or set ENV_MODE in
// gradle.properties. Values are read from root gradle.properties and emitted
// as a generated commonMain source file (Environment.kt).
...
val prodHost: String = stripQuotes(findProperty("API_BASE_URL")  as String? ?: "https://example.com")
val prodPort: String =            (findProperty("PROD_PORT")     as String? ?: "443")

val envScheme: String = if (envProfile == "prod") parseBaseUrl(prodHost).first else "http"
val envHost:   String = if (envProfile == "prod") parseBaseUrl(prodHost).second else devHost
...
val generateEnvironment = tasks.register("generateEnvironment") {
    ...
    doLast {
        val dir = outDir.get().asFile
            .resolve("homeaq/dothattask/dothattask_fe/dothattask_fe/Config")
        dir.mkdirs()
